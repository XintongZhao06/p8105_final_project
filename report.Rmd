...
$$
\begin{aligned}
\text{Engagement Score} = & \ \text{Comment Rate} \times 0.20 \ + \\
& \ \text{Share Rate} \times 0.30 \ + \\
& \ \text{Views} \times 0.20 \ + \\
& \ \text{Text Richness} \times 0.10 \ + \\
& \ \text{Weekend Effects} \times 0.10 \ + \\
& \ \text{Creator Tier Bonuses} \ (0-0.5)
\end{aligned}
$$
